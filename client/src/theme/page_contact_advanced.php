                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu active">
                                ...
                                <li class="active"><a href="page_contact_advanced.php">Contacts Advanced</a></li>
    ...
    <div class="container content">
    	<div class="row margin-bottom-30">
    		<div class="col-md-9 mb-margin-bottom-30">
                ...
                <form action="assets/php/demo-contacts-process.php" method="post" id="sky-form3" class="sky-form sky-changes-3">
                    <fieldset>                  
                        <div class="row">
